...
const Dropdown: React.FC<{
  ...
  <div className="mb-4">
    ...
    <select
      ...
      onChange={onChange}
      disabled={disabled}
      className="w-full bg-gray-700 border border-gray-600 rounded-md p-2 text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {options}
    </select>
  </div>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="font-bold text-teal-400">Cài đặt</h2>
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        <div className="mb-6 p-4 bg-gray-900 rounded-lg">
          <h3 className="font-semibold text-teal-500 mb-2">Chân dung Gia sư</h3>
          <p className="text-gray-400 whitespace-pre-wrap h-60 overflow-y-auto pr-2">{tutorDescription}</p>
        </div>
